...
const LibraryHeader = ({
  ...
  return (
    <div className='w-full h-full flex flex-col md:items-center xl:flex-row lg:justify-between lg:items-center gap-12 lg:px-12 xl:px-0 md:gap-16'>
      <div className='flex items-center w-full'>
        <div className='w-full flex flex-col md:items-center lg:items-start justify-center gap-7 xl:max-w-xl'>
          ...
          <div className='flex flex-col gap-3'>
            <div>
              {header ? (
                <h1 className='h2-base max-w-xl lg:max-w-full'>{header}</h1>
              ) : (
            ...
            {subhead ? (
              <div className='leading-snug w-full max-w-xl lg:max-w-full flex flex-col gap-3'>
                <div className='text-lg leading-snug'>{subhead}</div>
              </div>
            ) : (
              <div className='leading-snug max-w-xl w-full'>
                Explore the {displayName} Knowledge Library below. To learn how
                to make the most of your library, select your preferred
                instructional method to the right (advance through the slides or
                download them as a PDF). For additional assistance, feel free to
                contact us at{' '}
