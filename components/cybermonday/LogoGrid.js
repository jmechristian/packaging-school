  ...
  return (
    <div className='w-full h-full bg-zinc-900 pt-12 pb-24'>
      <div className='flex flex-col items-center justify-center w-full h-full'>
        ...
        <div className='max-w-7xl px-5 mx-auto mt-10 grid grid-cols-2 md:grid-cols-3 items-center gap-x-4 gap-y-10  sm:grid-cols-3 lg:grid-cols-6 lg:mx-0 opacity-60'>
          <img
            className='max-h-28 w-full object-contain lg:col-span-1 p-1'
          ...
          />
          <img
            className='max-h-28 w-full object-contain lg:col-span-1 invert p-4'
          ...
          />
          <img
            className='max-h-28 w-full object-contain lg:col-span-1 p-2'
          ...
          />
          <img
            className='max-h-28 w-full object-contain sm:col-start-auto lg:col-span-1 invert'
          ...
          />
          <img
            className='max-h-28 w-full object-contain sm:col-start-auto lg:col-span-1 invert p-5'
