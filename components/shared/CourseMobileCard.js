  ...
  return (
    <>
      <div
        ...
        className={`flex justify-between gap-3 p-3 border-b border-slate-200 ${
          isNavigating ? 'bg-slate-100 cursor-wait' : 'cursor-pointer active:bg-slate-50'
        }`}
      >
