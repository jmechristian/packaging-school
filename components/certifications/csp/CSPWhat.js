      ...
      <div className='grid lg:!grid-cols-5 gap-9 lg:!gap-20 justify-end lg:!pl-6 xl:!pl-0'>
        <div className='flex flex-col gap-9 col-span-3 p-6 lg:p-0'>
          ...
          <div className='flex flex-col gap-9'>
            ...
            <p className='dark:text-gray-500 text-slate-700 text-lg leading-normal font-greycliff tracking-wide max-w-prose lg:!max-w-none'>
              To that end, the Packaging School has crafted a self-paced online
              program designed to equip learners to fluently communicate in the
              language of sustainability, set and achieve UN-based
              ...
              integrate an ISO 14040–compliant life cycle assessment (LCA)
              software into their packaging design workflow and material
              selection processes.{' '}
              <strong>
                Learners will have six months of access to complete the program
              </strong>
              , providing ample time and flexibility to master these essential
