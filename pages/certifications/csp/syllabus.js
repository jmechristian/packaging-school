        ...
        <div className='flex flex-col'>
          ...
          <div className='md:p-10 p-6 flex flex-col gap-6 md:gap-10'>
            <div className='w-full rounded-xl md:bg-neutral-200 md:border md:border-neutral-900 md:p-9'>
              ...
              <p>
                Students in this <strong>40-hour </strong>workshop delivered
                over 10 weeks will redesign a package for sustainability through
                applying a four-phase process:
              </p>
              <ul className='flex flex-col gap-5 list-disc'>
                <li className='ml-6'>
                  Define the key terminology a learner needs to speak the
                  language of sustainability with colleagues and customers
                </li>
                <li className='ml-6'>
                ...
                <li className='ml-6'>
                  Select relevant offset programs to achieve carbon neutrality
                  at a per product/package
                </li>
                <li className='ml-6'>
                  Assess your environmental performance criteria through a
                  license to cutting-edge sustainability tools (ISO 14040
                  compliant life cycle analysis software) into your concept
                  development and material selection steps of packaging design
                </li>
              </ul>
            </div>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <p>
                ...
                course content at different times (and from different
                locations). As each assignment is completed, the instructors
                will guide the students, provide them with feedback, and make
                assessments as needed on assignments and activities.&nbsp;
              </p>
            </div>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <p>
                practical exercises/assignments, knowledge checks, discussion,
                and surveys. While everything is online, housed within a
                learning management system, online office hours will be provided
                upon request.&nbsp;
              </p>
            </div>
            <div className='flex flex-col gap-1'>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <ol className='flex flex-col gap-3 list-decimal'>
                <li className='ml-6'>
                  Maintain regular attendance (e.g., login to courses and
                  complete them within the 12- month assess time)&nbsp;
                </li>
                ...
                <li className='ml-6'>
                  Take all tests and exams given (see grading policy
                  below)&nbsp;
                </li>
              </ol>
            </div>
            <div className='flex flex-col gap-1'>
              ...
              <ol className='flex flex-col gap-3'>
                ...
                <li class='ql-indent-1'>
                  ...
                  The entire life cycle of the garbage we produce - from
                  disposal or recycling to the next stages - landfilling, energy
                ...
                <li class='ql-indent-1'>
                  <strong>Introduction to Frameworks</strong> (Video): Overview
                  of the terms linear model, circular module, and cradle to
                  grave
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  <strong>Green Engineering </strong>(Video): In depth
                  discussion of the 12 principles of green engineering
                </li>
                <li class='ql-indent-1'>
                  <strong>The Circular Economy </strong>(Video): Elements,
                  design, and flow of the circular economy
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  <strong>Introduction to Materials </strong>(Video): Overview
                  of the materials lesson
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  <strong>Plastics</strong> (Presentation): The impact of
                  plastics on the environment can be minimized with proper
                  management
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  ...
                  materials include bioplastics; cellophane; bamboo, mushroom,
                  and sugarcane packaging; and palm and reed fiber
                </li>
                <li class='ql-indent-1'>
                  <strong>
                    Packaging School&apos;s Guide to Edible Packaging{' '}
                  </strong>
                  (Presentation): Overview of the current state of the industry
                  of edible packaging
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  ...
                  tools step in to help companies see how their system affects
                  the environment
                </li>
                <li class='ql-indent-1'>
                  <strong>Life Cycle Analysis</strong> (Presentation):
                  Measurement of the sustainability of a product or system
                  through quantitative and objective methodologies regulated by
                  the ISO 14040
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  <strong>Corporate Goals and Reporting</strong> (Text): A look
                  at three real companies that are trying to reduce their
                ...
                <li class='ql-indent-1'>
                  ...
                  guides have set specified rules and regulations for companies
                  to meet in order to market their product as green
                </li>
                <li class='ql-indent-1'>
                  <strong>FTC Green Guides with Dr. Hurley </strong>(Video):
                  Describe the mission of FTC and the goal of the green guides,
                  summarize the green guide review process, and utilize the
                  green guide online&nbsp;
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  ...
                  cooperative tool to help determine the environmental profile
                  of your package
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  <strong>Introduction to Case Studies </strong>(Video):
                  Overview of specific company case studies we will look at
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  <strong>Biomimicry </strong>(Video): Vitalis water bottles
                  mimic nature so as to be both visually appealing and consume
                  less energy in production
                </li>
                <li class='ql-indent-1'>
                  <strong>eCommerce</strong> (Video)): Amazon is committed to
                  frustration free packaging that uses less packaging material
                  and The Honest Company has developed a lightweight, reusable
                ...
                <li class='ql-indent-1'>
                  <strong>A Sustainable Labeling Approach</strong> (Video):
                  Onsite interview with UPM Raflatac to discuss their
                ...
                <li class='ql-indent-1'>
                  <strong>UN SDGs Introduction: </strong>(Video): Overview of
                  the module ahead
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  <strong>UN SDG 2 - Zero Hunger</strong> (Video): Discuss UN
                  SDG with examples and applications&nbsp;
                </li>
                <li class='ql-indent-1'>
                  <strong>UN SDG 3 - Good Health and Well-Being </strong>
                ...
                <li class='ql-indent-1'>
                  <strong>UN SDG 5 - Gender Equality </strong>(Video): Discuss
                  UN SDG with examples and applications&nbsp;
                </li>
                <li class='ql-indent-1'>
                  <strong>UN SDG 6 - Clean Water and Sanitation </strong>
                  (Video): Discuss UN SDG with examples and applications&nbsp;
                </li>
                <li class='ql-indent-1'>
                  <strong>UN SDG 7 - Affordable and Clean Energy</strong>{' '}
                  (Video): Discuss UN SDG with examples and applications&nbsp;
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  <strong>UN SDG 13 - Climate Action</strong> (Video): Discuss
                  UN SDG with examples and applications&nbsp;
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  <strong>UN SDG 17 - Partnerships for the Goals</strong>{' '}
                  (Video): Discuss UN SDG with examples and applications&nbsp;
                </li>
                <li class='ql-indent-1'>
                  <strong>UN SDGs Conclusion</strong> (Video): Summarize the 17
                  goals and how they can apply to your organization at
                  large&nbsp;
                </li>
                <li>
                ...
                <li class='ql-indent-1'>
                  ...
                  goals:&nbsp; Silgan Containers, Berry Plastics,
                  Owens-Illinois, Clorox, Target, Costco, Coca-Cola, P&amp;G,
                  Nestle, Kraft Heinz, and Mondelez
                </li>
                <li class='ql-indent-1'>
                  <strong>EPR for Packaging Webinar</strong> (Video):
                  Objectively present elements of EPR for educational purposes
                  only—what we discuss should not be interpreted as legal
                  advice&nbsp;
                </li>
                <li class='ql-indent-1'>
                  <strong>German Recycling Machines </strong>(Video): Highlight
                  a recycling machine in Germany&nbsp;
                </li>
                <li>
                  <strong>Sustainability Module 9</strong>
                </li>
                <li class='ql-indent-1'>
                  <strong>Apply What You Learned</strong> (Forum): Apply what
                  you have learned by grabbing something within your immediate
                ...
                <li class='ql-indent-1'>
                  ...
                  experience within your role at your company, choose a
                  packaging system (e.g., dunnage, tape, corrugated box, etc.)
                  that you want to improve and write a 200 word explanation on
                  why this package needs to be redesigned.&nbsp;
                </li>
                <li>
                ...
                <li class='ql-indent-1'>
                  ...
                  Analyze our seven-step process that you can use as a
                  foundation for your own innovation process within your
                  organization
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  ...
                  (Video): Differentiate between authentic sustainable
                  innovation and greenwashing
                </li>
                <li class='ql-indent-1'>
                  <strong>Knowledge Check</strong> (Quiz, 5 questions): Helps
                ...
                <li class='ql-indent-1'>
                  <strong>Force Think</strong> (Video): Discuss this
                  brainstorming using packaging examples&nbsp;
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  <strong>SCAMPER Exercise</strong> (Assignment): Use the
                  SCAMPER brainstorming method to generate ideas for your
                  improved packaged product&nbsp;
                </li>
                <li>
                  <strong>Goal Setting Module 5</strong>
                </li>
                ...
                <li class='ql-indent-1'>
                  ...
                  (if these are not available to you, a sketch or series of
                  images works).
                </li>
                <li>
                ...
                <li class='ql-indent-1'>
                  <strong>Let&apos;s Collaborate</strong> (Discussion): Discuss
                  and respond to your peers about the idea of offsetting carbon
                ...
                <li class='ql-indent-1'>
                  ...
                  (PDF): Summarize resources to aid you in the calculation
                  process
                </li>
                <li class='ql-indent-1'>
                  <strong>
                ...
                <li class='ql-indent-1'>
                  <strong>Before Your Begin </strong>(Directions): Instruct on
                  how to sign up for the life cycle analysis software&nbsp;
                </li>
                <li class='ql-indent-1'>
                ...
                <li class='ql-indent-1'>
                  <strong>Data Entry </strong>(Video): Use a packaging scenario
                ...
                <li class='ql-indent-1'>
                  ...
                  (Assignment): Based on all your findings from the program,
                  come up with a 30 second video pitch on how you plan to
                  implement these changes within your company.&nbsp;
                </li>
                <li>
                ...
                <li class='ql-indent-1'>
                  ...
                  (Downloadable Assets): Explore resources that will assist you
                  in diving deeper into topics of interest
                </li>
              </ol>
            </div>
            <div className='flex flex-col gap-1'>
              ...
              <p>
                ...
                internet and/or a computer if requested. All other requirements
                to complete any course or assignment within the Packaging School
                are embedded in the learning management system. Students will
                not be asked to purchase any other technology in order to
                complete the program. The lessons are accessible from any
                smartphone or tablet. Chrome is the recommended web browser. At
                this time, students may not download any material for offline
                viewing unless it is intuitive to do so. Students are
                responsible for their own computer maintenance.
              </p>
            </div>
            <div className='flex flex-col gap-1'>
              <h1>
              ...
              <ol className='flex flex-col gap-3'>
                <li>
                  ...
                  inappropriate use of internet research, in any work submitted
                  to fulfill academic requirements. In examination situations
                  all outside resources must be inaccessible unless otherwise
            ...
            <div className='flex flex-col gap-1'>
              ...
              <p>
                ...
                should first attempt to resolve the situation with the
                instructor: Dr. Suggs, Julie@packagingschool.com 864-412-5000.
              </p>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <p>
                ...
                objectives. Knowledge checks are not graded. However, they must
                be completed. Knowledge checks test retention of the teachings
                and help the student prepare for the final exam. Passing the
                course requires an 80% or greater on the final exam. Student
                completion progress is presented with the completion of every
                lesson in the LMS. Grades are reported to students at the end of
                each course and a final grade is submitted upon completion of
                the final exam. Students are notified by email each week if they
                have outstanding course material that has not been completed.
                Transcripts will be held digitally and are considered Permanent
                Records which are held indefinitely. Attendance is recorded for
                each login session in the LMS, and all engagement with the
              ...
              <p>
                ...
                complete every course in the program&apos;s curriculum in order
                to receive the certificate of completion at the end of the
                program.
              </p>
            </div>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <p>
                ...
                encouraged to protect their password and account. Only one
                student per account is permitted. IP addresses are monitored to
                ensure that students are not sharing their account with
                individuals in another location. Proctoring software is used
                during exams to ensure that students are who they say they are.
                Accredible is used to verify that the same person who completes
                coursework and assignments receives the certificate and digital
                badge.
              </p>
            </div>
            <div className='flex flex-col gap-1'>
              ...
              <p>
                The Packaging School is committed to providing an environment
                that is free from discrimination on the basis of race, color,
                national origin, sex, sexual orientation, or disability in its
                educational courses and employment practices. If any student,
                faculty, staff or applicant has a question or concern regarding
                compliance with this policy, that person may direct the question
                or concern to Student Services.
              </p>
            </div>
          </div>
        </div>
