...
function App() {
  ...
  return (
    <div className='w-full flex flex-col gap-16 lg:gap-24 relative'>
      {/* INTRO */}
        ...
        <div className='absolute right-1/4 translate-x-1/4 top-0 w-full lg:w-1/3 h-full flex flex-col justify-center gap-10'>
          <div className='w-full flex flex-col gap-4'>
            ...
            <div className='w-full h-full text-white text-lg'>
              Create your account and explore industry-leading courses and
              certifications designed by subject-matter experts.
            </div>
          </div>
          <div className='w-full flex flex-col gap-4'>
            ...
            <div className='w-full'>
              <button className='w-full bg-clemson text-white font-bold text-lg p-4'>
