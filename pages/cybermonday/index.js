          ...
          <div className='flex flex-col gap-8'>
            <div className='flex flex-col justify-center items-center relative text-center max-w-4xl mx-auto gap-10'>
              ...
              <div className='text-xl text-zinc-800'>
                Give yourself the gift of education this season! To celebrate
                our 10-year anniversary, we’re launching 10 days of limited,
                first-come-first-serve coupons—a new one released every day.
                Will you be the first to snag it?
              </div>
            </div>
          </div>
        </div>
        <div className='w-full max-w-6xl mx-auto bg-zinc-900 rounded-[2.5rem] p-16 relative overflow-hidden'>
          ...
          <div className=' text-white text-center mt-8 px-6'>
            *If you’re applying to the Certificate of Packaging Science, be sure
            to email us at info@packagingschool.com after you apply to claim
            your coupon.
          </div>
        </div>
