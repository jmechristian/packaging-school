...
const CourseCard = ({ course }) => {
  ...
  const orderHandler = async () => {
    ...
    const orderId = await createNewOrder({
      ...
      courseLink: `${courseData.link}?coupon=churchanddwight2025`,
...
const Page = () => {
  const faqs = [
    {
      ...
      answer:
        'If you have any questions regarding curriculum, reach out to michael.pinchiaroli@churchdwight.com. ',
    },
    {
      id: 2,
  ...
  return (
    <div className='w-full flex flex-col pt-10 pb-40'>
      <Head>
        <title>Church & Dwight | The Packaging School</title>
      ...
      <div className='w-full max-w-7xl mx-auto flex flex-col gap-10 pt-8 pb-16 border-b border-gray-300'>
        <div className='w-full flex flex-col gap-5 mt-12 lg:mt-0'>
          <div className='max-w-xl w-full text-gray-700'>
            Church & Dwight is deeply committed to investing in the growth and
            ...
            commitment, Church & Dwight has partnered with The Packaging School
            to provide our packaging team with access to industry-leading
            education tailored to their unique needs.
          </div>
          <div className='max-w-xl w-full text-gray-700'>
            This program is designed to help our packaging professionals
            continue to level up—whether they’re building foundational knowledge
            or advancing into more specialized areas. The curriculum covers key
            topics such as packaging materials, industrial processes, design,
            supply chain, sustainability, and industry trends. With more than
            4,000 continuously updated learning assets, this initiative empowers
            our packaging team to sharpen their skills, stay ahead of industry
            changes, and grow their careers at Church & Dwight.
          </div>
        </div>
      </div>
