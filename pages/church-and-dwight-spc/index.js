...
const CourseCard = ({ course }) => {
  ...
  const orderHandler = async () => {
    const orderId = await createNewOrder({
      ...
      courseLink: `${courseData.link}?coupon=cdspc`,
      ...
      <div className='w-full max-w-7xl mx-auto flex flex-col gap-10 pt-8 pb-16 border-b border-gray-300'>
        <div className='w-full flex flex-col gap-5 mt-12 lg:mt-0'>
          <div className='max-w-xl w-full text-gray-700'>
            Church & Dwight is committed to the professional growth of its
            employees, recognizing that continuous learning is essential to
            innovation and long-term success. As part of this commitment, we’re
            excited to offer access to the Sustainable Packaging Coalition (SPC)
            Knowledge Library, developed in partnership with The Packaging
            School.
          </div>
          <div className='max-w-xl w-full text-gray-700'>
            This exclusive resource is available at no cost to Church & Dwight
            employees through our company’s SPC membership. The Knowledge
            Library is designed to support your development in sustainable
            packaging—whether you’re building a foundation or diving into
            advanced topics.
          </div>
        </div>
      </div>
