  ...
  return (
    <>
      <Meta
        ...
        description={
          "Oops! The page you're looking for can't be found. Explore our site to find exactly what you need or contact us for assistance."
        }
        seoImage={'https://packschool.s3.amazonaws.com/404-seoimage.webp'}
      />
                  ...
                  return [
                    ...
                    },
                    {
                      ...
                      templates: {
                        item({ item, components }) {
                          return (
                            <CertItem hit={item} components={components} />
                          );
                        },
                      },
                    },
                    {
                      ...
                      templates: {
                        item({ item, components }) {
                          return (
                            <LOTMItem hit={item} components={components} />
                          );
                        },
                      },
                    },
