      ...
      <div className='w-full grid lg:grid-cols-12 gap-24 px-4 xl:px-0'>
        <div className='lg:col-span-6 flex flex-col gap-3'>
          ...
          <p className='text-lg text-gray-600'>
            ...
            packaging materials, processes, and technologies — delivered through
            more than 4,000 short, practical lessons. Choose the courses that
            matter most to your organization to create a targeted training
            experience that is efficient, relevant, and immediately applicable
            on the job.
          </p>
        </div>
        ...
        <div className='relative overflow-hidden bg-gray-100/90 p-8 sm:p-10 lg:p-20 shadow-sm'>
          <div className='max-w-3xl mx-auto text-center'>
            ...
            <p className='mt-6 text-sm sm:text-base text-slate-600'>
              ...
              accelerate onboarding, and scale packaging knowledge across global
              teams. With structured, team‑focused learning pathways, companies
              drive measurable capability growth while supporting continuous
